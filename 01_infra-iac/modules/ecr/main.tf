...
# FaaS Builder Repository
resource "aws_ecr_repository" "faas_builder" {
  name                 = "${var.project_name}-faas-builder"
  image_tag_mutability = "MUTABLE"
...
# FaaS App - No lifecycle policy (infinite retention)
