...
resource "aws_iam_role_policy" "k3s_control_plane_alb" {
  name = "${var.name_prefix}-k3s-control-plane-alb-policy"
  role = aws_iam_role.k3s_control_plane.id
...
resource "aws_iam_role_policy" "k3s_worker_alb" {
  name = "${var.name_prefix}-k3s-worker-alb-policy"
  role = aws_iam_role.k3s_worker.id
